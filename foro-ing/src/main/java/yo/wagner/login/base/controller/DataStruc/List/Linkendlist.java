package yo.wagner.login.base.controller.DataStruc.List;
...
public class Linkendlist<E> {
    ...
    private Node<E> getNode(Integer pos) throws Exception{
        if (isEmpty()) {
    ...
    private E getDattaFirst() throws Exception{
        if (isEmpty()) {
    ...
    private E getDataLast() throws Exception{
        if (isEmpty()) {
            throw new Exception("La lista esta vacia");
        } else {
            return last.getData();
    ...
    // protected E deleteLast() throwsException{
    //     if (isEmpty()) {
    //         throw new Exception("La lista se encuentra vacia");
    //     } else {
    ...
    // public E delete(Integer pos) throwsException{
    //     if (isEmpty()) {
    //         throw new Exception("La lista se encuentra vacia");
    //     } else if (pos < 0 || pos >= length) {
    //         throw new Exception("Indice fuera de rango");
