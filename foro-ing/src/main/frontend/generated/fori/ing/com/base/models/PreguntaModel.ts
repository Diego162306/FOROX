...
class PreguntaModel<T extends Pregunta_1 = Pregunta_1> extends ObjectModel_1<T> {
    ...
    get idArchivoadjunto(): NumberModel_1 {
        return this[_getPropertyModel_1]("idArchivoadjunto", (parent, key) => new NumberModel_1(parent, key, true, { meta: { javaType: "java.lang.Integer" } }));
    }
