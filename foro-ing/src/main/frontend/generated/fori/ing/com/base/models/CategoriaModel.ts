...
import type Categoria_1 from "./Categoria.js";
class CategoriaModel<T extends Categoria_1 = Categoria_1> extends ObjectModel_1<T> {
    static override createEmptyValue = makeObjectEmptyValueCreator_1(CategoriaModel);
