...
import type Categoria_1 from "./yo/wagner/login/base/models/Categoria.js";
...
async function listAll_1(init?: EndpointRequestInit_1): Promise<Array<Record<string, unknown> | undefined> | undefined> { return client_1.call("CategoriaService", "listAll", {}, init); }
