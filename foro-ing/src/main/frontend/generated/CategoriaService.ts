...
async function order_1(atributo: string | undefined, type: number | undefined, init?: EndpointRequestInit_1): Promise<Array<Categoria_1 | undefined> | undefined> { return client_1.call("CategoriaService", "order", { atributo, type }, init); }
...
export { createCategoria_1 as createCategoria, listAll_1 as listAll, order_1 as order, updateCategoria_1 as updateCategoria };
