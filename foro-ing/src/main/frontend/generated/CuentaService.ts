...
async function createCuenta_1(correo: string | undefined, clave: string | undefined, idUsuario: number | undefined, init?: EndpointRequestInit_1): Promise<void> { return client_1.call("CuentaService", "createCuenta", { correo, clave, idUsuario }, init); }
