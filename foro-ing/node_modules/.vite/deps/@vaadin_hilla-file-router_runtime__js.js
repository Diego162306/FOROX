  ...
  withFileRoutes(routes) {
    return this.update(routes, ({ original, overriding: added, children }) => {
      ...
      if (added) {
        ...
        const element = (module == null ? void 0 : module.default) ? (0, import_react.createElement)(module.default) : void 0;
        const handle = {
          ...module == null ? void 0 : module.config,
  ...
  */
  withFallback(component, config) {
    ...
    const fallbackRoutes = [{
      path: "*",
      element: (0, import_react.createElement)(component),
      handle: config
    }, {
      index: true,
      element: (0, import_react.createElement)(component),
    ...
    __privateGet(this, _modifiers).push((originalRoutes) => {
      ...
      return [
        ...result.server.length ? [{
          element: (0, import_react.createElement)(layoutComponent),
